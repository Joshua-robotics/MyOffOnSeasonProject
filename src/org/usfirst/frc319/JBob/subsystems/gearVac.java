...
public class gearVac extends Subsystem {
    ...
    private final DoubleSolenoid gearPiston = RobotMap.gearVacgearPiston;
    private final CANTalon gearVacMotor = RobotMap.gearVacgearVacMotor;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new GearVacStop());
