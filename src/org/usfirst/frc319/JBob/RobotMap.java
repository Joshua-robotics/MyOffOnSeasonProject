...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("rollervator", "rollervatorLead", rollervatorrollervatorLead);
        
        rollervatorrollervatorFollow = new CANTalon(6);
        LiveWindow.addActuator("rollervator", "rollervatorFollow", rollervatorrollervatorFollow);
        ...
        LiveWindow.addActuator("brakePad", "brakePadPiston", brakePadbrakePadPiston);
        
        activeFlooractiveFloor = new CANTalon(8);
        LiveWindow.addActuator("activeFloor", "activeFloor", activeFlooractiveFloor);
