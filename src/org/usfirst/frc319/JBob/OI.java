...
public class OI {
    ...
    public OI() {
        ...
        yButton.whenPressed(new FuelVacGo());
        ...
        SmartDashboard.putData("FuelVacGo", new FuelVacGo());
        SmartDashboard.putData("AutonomousCommand", new AutonomousCommand());
        SmartDashboard.putData("JoystickDrive", new JoystickDrive());
        SmartDashboard.putData("FuelVacStop", new FuelVacStop());
        SmartDashboard.putData("GearVacGo", new GearVacGo());
        SmartDashboard.putData("GearVacStop", new GearVacStop());
